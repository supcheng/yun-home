...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/admin/room/add"
                  method="post" enctype="multipart/form-data">
                <div class="row data-type" style="margin: 0px">
                    <div class="col-md-2 title">房屋发布标题</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               placeholder="房屋标题" name="title" required>
                    </div>
                    <div class="col-md-2 title">月租金</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               placeholder="月租金" name="rent" required>
                    </div>
                    <div class="col-md-2 title">房型</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               placeholder="房型" name="roomType" required>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               placeholder="房源地址" name="address" required>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               placeholder="房源面积" name="area" required>
                    </div>
                        ...
                        <div class="form-group form-inline">
                            <div class="radio"><label>
                                <input type="radio" name="rentType"
                                       value="合租" checked>合租</label></div>
                            <div class="radio"><label>
                                <input type="radio" name="rentType"
                                       value="整租">整租</label></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               placeholder="房屋描述" name="roomDesc" required>
                    </div>
